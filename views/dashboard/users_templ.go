...
func transformUsersToTableRows(users []models.User) components.TableRowElements {
...
func UsersList(users models.PaginatedUsers, currentPage int32, perPage int32) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("Showing %d users", users.TotalCount))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/dashboard/users.templ`, Line: 53, Col: 90}
			}
			...
			templ_7745c5c3_Err = components.Table(
				...
				transformUsersToTableRows(users.Users),
				components.TablePagination{
					TotalCount:  users.TotalCount,
					Page:        currentPage,
					PageSize:    perPage,
					TotalPages:  users.TotalPages,
					HasNext:     currentPage < users.TotalPages,
